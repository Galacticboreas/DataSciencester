...
# выпадения орла, и выдвигается нулевая гипотеза о том, что монета уравнове-
...
# подсчетом количества орлов Х. Каждый бросок монеты - это бернуллиево испытание,
...
# Если гипотеза об уравновешенности монеты является истинной,
